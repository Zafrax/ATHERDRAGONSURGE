...
public class DragonNiteDirtBlock extends AtherTheDragonSurgeModElements.ModElement {
	@ObjectHolder("ather_the_dragon_surge:dragon_nite_dirt")
	public static final Block block = null;
	public DragonNiteDirtBlock(AtherTheDragonSurgeModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dragon_nite_dirt");
		}
