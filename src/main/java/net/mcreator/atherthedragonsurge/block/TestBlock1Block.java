...
public class TestBlock1Block extends AtherTheDragonSurgeModElements.ModElement {
	@ObjectHolder("ather_the_dragon_surge:test_block_1")
	public static final Block block = null;
	public TestBlock1Block(AtherTheDragonSurgeModElements instance) {
		super(instance, 7);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("test_block_1", "test_block_1", blockAt -> {
			...
			}), block.getDefaultState(), 16)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(10, 1, 1, 12))));
		}
	}
}
