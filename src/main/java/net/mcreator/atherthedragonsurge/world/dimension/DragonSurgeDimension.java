...
package net.mcreator.atherthedragonsurge.world.dimension;
...
public class DragonSurgeDimension extends AtherTheDragonSurgeModElements.ModElement {
	@ObjectHolder("ather_the_dragon_surge:dragon_surge")
	public static final ModDimension dimension = null;
	@ObjectHolder("ather_the_dragon_surge:dragon_surge_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DragonSurgeDimension(AtherTheDragonSurgeModElements instance) {
		super(instance, 1);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("dragon_surge"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("ather_the_dragon_surge:dragon_surge")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("ather_the_dragon_surge:dragon_surge"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("ather_the_dragon_surge:dragon_surge"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new DragonSurgeItem().setRegistryName("dragon_surge"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("dragon_surge_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = DragonSurgeDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dragon_surge_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "dragon_surge_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = DragonSurgeDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(Block1Block.block.getDefaultState().getBlock(),
