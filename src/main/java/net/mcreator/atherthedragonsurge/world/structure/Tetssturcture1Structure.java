...
package net.mcreator.atherthedragonsurge.world.structure;
...
public class Tetssturcture1Structure extends AtherTheDragonSurgeModElements.ModElement {
	public Tetssturcture1Structure(AtherTheDragonSurgeModElements instance) {
		super(instance, 9);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 25) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("ather_the_dragon_surge", "maison1-1558119604"));
						if (template == null)
							return false;
